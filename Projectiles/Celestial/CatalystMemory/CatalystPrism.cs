...
namespace StarsAbove.Projectiles.Celestial.CatalystMemory
{
    public class CatalystPrism : ModProjectile
    {
        ...
        {
            Dust.NewDust(Projectile.Center, 0, 0, DustID.GemAmethyst, Main.rand.NextFloat(-1, 1), Main.rand.NextFloat(-1, 1), 150, default, 0.5f);
            Dust.NewDust(Projectile.Center, 0, 0, DustID.PurpleCrystalShard, Main.rand.NextFloat(-2, 2), Main.rand.NextFloat(-2, 2), 150, default, 0.7f);
